...
#install NVM
su -c "curl -o- https://raw.githubusercontent.com/creationix/nvm/v0.33.11/install.sh | bash && \. ~/.nvm/nvm.sh && nvm install 10 && nvm use 10" vagrant
